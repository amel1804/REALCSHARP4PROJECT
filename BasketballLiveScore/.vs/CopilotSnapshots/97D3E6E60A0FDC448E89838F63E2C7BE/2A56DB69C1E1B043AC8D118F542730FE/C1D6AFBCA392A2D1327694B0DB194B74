...
namespace BasketballLiveScore.Repositories.Implementations
{
    ...
    public class UnitOfWork : IUnitOfWork, IDisposable
    {
        ...
        /// <summary>
        /// Repository des �v�nements de match
        /// </summary>
        public IMatchEventRepository MatchEvents => _matchEvents ??= new MatchEventRepository(_context);

        /// <summary>
        /// Sauvegarde tous les changements dans la base de donn�es
        ...
        /// <summary>
        /// Sauvegarde tous les changements de mani�re asynchrone
        ...
        /// <summary>
        /// Lib�re les ressources du contexte
